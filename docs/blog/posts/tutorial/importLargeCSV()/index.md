...
description: Script in Google Apps Script che permette di importare un file CSV che supera il limite di dimensione in Google Sheets.
draft: false
date: 2024-04-01
authors:
  - gbvitrano
...
tags:
  ...
  - google sheets
  - script
social_image: assets/img/social/perplexity.jpg
---
<style>
.md-typeset code { background-color: #fff0;}  
.md-typeset pre>code { background-color: #fff0;}  
</style>
[![importLargeCSV](errore.png "Script in Google Apps Script che permette di importare un file CSV che supera il limite di dimensione in Google Sheets" ){class="crop gray" align=right}](index.md)
